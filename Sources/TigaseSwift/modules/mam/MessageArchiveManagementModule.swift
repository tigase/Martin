...
extension MessageArchiveManagementModule {
    ...
    open func queryItems(version: Version? = nil, componentJid: JID? = nil, node: String? = nil, query: JabberDataElement, queryId: String, rsm: RSM.Query? = nil) async throws -> QueryResult
    {
        return try await withUnsafeThrowingContinuation { continuation in
    ...
    open func retrieveForm(version: Version? = nil, componentJid: JID? = nil) async throws -> JabberDataElement {
        return try await withUnsafeThrowingContinuation { continuation in
