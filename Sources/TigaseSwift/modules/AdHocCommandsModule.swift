...
extension AdHocCommandsModule {
    ...
    public func execute(on to: JID?, command node: String, action: Action?, data: DataForm?, completionHandler: @escaping (Result<AdHocCommandsModule.Response, XMPPError>)->Void) {
        Task {
            do {
