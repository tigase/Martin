...
extension MucModule {
    ...
    open func roomConfiguration(roomJid: JID) async throws -> JabberDataElement {
        return try await withUnsafeThrowingContinuation { continuation in
    ...
    open func setRoomConfiguration(roomJid: JID, configuration: JabberDataElement) async throws {
        return try await withUnsafeThrowingContinuation { continuation in
